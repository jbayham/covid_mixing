% 4) The script assumes children in school and working parents adopt their 
...
donor=icontact(icontact.weekend==1 & icontact.where~=8,[{'start','stop','actdur','tucaseid','actnum','where'} matchvars]);
...
save(sprintf('%s%s',tupath,'MixingDataset_HH_weekend.mat'),'contact','cut','labels','loclabels','-v7.3')
